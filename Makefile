...
dockerBuildExamples:
	...
	cd examples/actors-dp-java && docker build -f Dockerfile.liberty --build-arg JAVA_BUILDER=$(KAR_JAVA_SDK) --build-arg JAVA_RUNTIME=$(KAR_JAVA_RUNTIME) -t $(KAR_EXAMPLE_JAVA_DP) .
