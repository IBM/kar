...
async function main () {
  ...
  console.log(await actor.getReminder('Foo', '22', 'noone'))
  console.log(await actor.getReminder('Foo', '22', ''))
  console.log(await actor.getReminder('Foo', '22', 'ticker'))
  await sleep(20000)
  await actor.cancelReminder('Foo', '22', 'ticker')
