...
async function main () {
  ...
  await actor.reminders.schedule(a22, 'echo', { id: 'ticker', deadline, period, data: { msg: 'hello' } })
  await actor.reminders.schedule(a23, 'echo', { id: 'ticker', deadline, period })
  await actor.reminders.schedule(a2112, 'echo', { id: 'ticker', deadline, period, data: { msg: 'Syrinx' } })
  await actor.reminders.schedule(a22, 'echo', { id: 'once', deadline, data: { msg: 'carpe diem' } })
